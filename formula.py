...
a_greater_b_4_bit = f"(a3 NAND NOT b3) NAND ( {x3} NAND ((a2 NAND NOT b2) NAND ({x2} NAND ((a1 NAND NOT b1) NAND ({x1} NAND ( a0 AND NOT b0 )))))) table"
